...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfficeHeld.confirmed'
        db.add_column('modernpolitics_officeheld', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfficeHeld.confirmed'
        db.delete_column('modernpolitics_officeheld', 'confirmed')
