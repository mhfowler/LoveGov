...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.email_subscriptions'
        db.add_column('modernpolitics_userprofile', 'email_subscriptions',
                      self.gf('django.db.models.fields.CharField')(default='AW', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.email_subscriptions'
        db.delete_column('modernpolitics_userprofile', 'email_subscriptions')
