...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('modernpolitics_userprofile', 'twitter_user_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'UserProfile.twitter_screen_name'
        db.add_column('modernpolitics_userprofile', 'twitter_screen_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('modernpolitics_userprofile', 'twitter_user_id')

        # Deleting field 'UserProfile.twitter_screen_name'
        db.delete_column('modernpolitics_userprofile', 'twitter_screen_name')
