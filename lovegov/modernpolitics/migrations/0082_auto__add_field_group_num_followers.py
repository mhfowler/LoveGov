...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.num_followers'
        db.add_column('modernpolitics_group', 'num_followers',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.num_followers'
        db.delete_column('modernpolitics_group', 'num_followers')
