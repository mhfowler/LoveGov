...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnswerTally'
        db.create_table('modernpolitics_answertally', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Answer'], null=True)),
            ('tally', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('modernpolitics', ['AnswerTally'])

        # Deleting field 'Response.answers'
        db.delete_column('modernpolitics_response', 'answers')

        # Adding field 'Response.most_chosen_answer'
        db.add_column('modernpolitics_response', 'most_chosen_answer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='responses', null=True, to=orm['modernpolitics.Answer']),
                      keep_default=False)

        # Adding field 'Response.most_chosen_num'
        db.add_column('modernpolitics_response', 'most_chosen_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Response.total_num'
        db.add_column('modernpolitics_response', 'total_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Response.explanation'
        db.add_column('modernpolitics_response', 'explanation',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding M2M table for field answer_tallies on 'Response'
        db.create_table('modernpolitics_response_answer_tallies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('response', models.ForeignKey(orm['modernpolitics.response'], null=False)),
            ('answertally', models.ForeignKey(orm['modernpolitics.answertally'], null=False))
        ))
        db.create_unique('modernpolitics_response_answer_tallies', ['response_id', 'answertally_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AnswerTally'
        db.delete_table('modernpolitics_answertally')

        # Adding field 'Response.answers'
        db.add_column('modernpolitics_response', 'answers',
                      self.gf('lovegov.modernpolitics.custom_fields.ListField')(default=[]),
                      keep_default=False)

        # Deleting field 'Response.most_chosen_answer'
        db.delete_column('modernpolitics_response', 'most_chosen_answer_id')

        # Deleting field 'Response.most_chosen_num'
        db.delete_column('modernpolitics_response', 'most_chosen_num')

        # Deleting field 'Response.total_num'
        db.delete_column('modernpolitics_response', 'total_num')

        # Deleting field 'Response.explanation'
        db.delete_column('modernpolitics_response', 'explanation')

        # Removing M2M table for field answer_tallies on 'Response'
        db.delete_table('modernpolitics_response_answer_tallies')
