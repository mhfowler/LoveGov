...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnalyticsTask'
        db.create_table('modernpolitics_analyticstask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('modifiers_json', self.gf('django.db.models.fields.CharField')(default='{}', max_length=500)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('modernpolitics', ['AnalyticsTask'])

        # Adding M2M table for field completed_analytics_tasks on 'UserProfile'
        db.create_table('modernpolitics_userprofile_completed_analytics_tasks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('analyticstask', models.ForeignKey(orm['modernpolitics.analyticstask'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_completed_analytics_tasks', ['userprofile_id', 'analyticstask_id'])


    def backwards(self, orm):
        # Deleting model 'AnalyticsTask'
        db.delete_table('modernpolitics_analyticstask')

        # Removing M2M table for field completed_analytics_tasks on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_completed_analytics_tasks')
    ...
    models = {
        ...
        'modernpolitics.analyticstask': {
            'Meta': {'object_name': 'AnalyticsTask'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiers_json': ('django.db.models.fields.CharField', [], {'default': "'{}'", 'max_length': '500'}),
        ...
        'modernpolitics.clientanalytics': {
            ...
            'test_run': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modernpolitics.UserProfile']"}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        ...
        'modernpolitics.content': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modernpolitics.UserProfile']", 'null': 'True'}),
            'default_sort': ('django.db.models.fields.CharField', [], {'default': "'h'", 'max_length': '1'}),
        ...
        'modernpolitics.cookiedata': {
            'Meta': {'object_name': 'CookieData'},
            'claimed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'claimed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'my_cookie_datas'", 'null': 'True', 'to': "orm['modernpolitics.UserProfile']"}),
            'created_when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ipaddress': ('django.db.models.fields.IPAddressField', [], {'default': "'255.255.255.255'", 'max_length': '15', 'null': 'True'}),
            'supports': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'cookie_supporters'", 'symmetrical': 'False', 'to': "orm['modernpolitics.UserProfile']"}),
            'view': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modernpolitics.WorldView']", 'null': 'True'})
        },
        ...
        'modernpolitics.emailsent': {
            'Meta': {'object_name': 'EmailSent'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'when': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'which': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        ...
        'modernpolitics.pageaccess': {
            ...
            'post_parameters': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'null': 'True'}),
        ...
        'modernpolitics.physicaladdress': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
        ...
        'modernpolitics.question': {
            ...
            'official_order': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            ...
            'top_poll': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modernpolitics.Poll']", 'null': 'True'})
        },
        'modernpolitics.rankedcontent': {
            'Meta': {'object_name': 'RankedContent'},
            'content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ranked_by'", 'to': "orm['modernpolitics.Content']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ranked_it'", 'to': "orm['modernpolitics.UserProfile']"})
        },
        ...
        'modernpolitics.seencontent': {
            'Meta': {'object_name': 'SeenContent'},
            'content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'seen_by'", 'to': "orm['modernpolitics.Content']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'seen': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        ...
        'modernpolitics.tolovegov': {
            'Meta': {'object_name': 'toLoveGov'},
            'clicks': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_where': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'who': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'})
        },
        ...
        'modernpolitics.unsubscribedtoemail': {
            'Meta': {'object_name': 'UnsubscribedToEmail'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        ...
        'modernpolitics.userprofile': {
            ...
            'completed_analytics_tasks': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['modernpolitics.AnalyticsTask']", 'symmetrical': 'False'}),
            ...
            'digested_content': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'digested_by'", 'symmetrical': 'False', 'to': "orm['modernpolitics.Content']"}),
            ...
            'email_subscriptions': ('django.db.models.fields.CharField', [], {'default': "'AW'", 'max_length': '40', 'blank': 'True'}),
            ...
            'hot_feed': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'ranker'", 'symmetrical': 'False', 'through': "orm['modernpolitics.RankedContent']", 'to': "orm['modernpolitics.Content']"}),
            ...
            'last_updated_hot_feed': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'last_updated_like_minded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'seen_content': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'seeing_users'", 'symmetrical': 'False', 'to': "orm['modernpolitics.SeenContent']"}),
            'stale_content': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'stale_users'", 'symmetrical': 'False', 'to': "orm['modernpolitics.Content']"}),
