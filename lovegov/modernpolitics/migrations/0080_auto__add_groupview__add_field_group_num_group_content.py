...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupView'
        db.create_table('modernpolitics_groupview', (
        ...
        db.send_create_signal('modernpolitics', ['GroupView'])

        # Adding M2M table for field group_views on 'UserProfile'
        db.create_table('modernpolitics_userprofile_group_views', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('groupview', models.ForeignKey(orm['modernpolitics.groupview'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_group_views', ['userprofile_id', 'groupview_id'])

        # Adding field 'Group.num_group_content'
        db.add_column('modernpolitics_group', 'num_group_content',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GroupView'
        db.delete_table('modernpolitics_groupview')

        # Removing M2M table for field group_views on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_group_views')

        # Deleting field 'Group.num_group_content'
        db.delete_column('modernpolitics_group', 'num_group_content')
