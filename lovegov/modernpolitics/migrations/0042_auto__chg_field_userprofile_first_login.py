...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.first_login'
        db.alter_column('modernpolitics_userprofile', 'first_login', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.first_login'
        db.alter_column('modernpolitics_userprofile', 'first_login', self.gf('django.db.models.fields.BooleanField')())
