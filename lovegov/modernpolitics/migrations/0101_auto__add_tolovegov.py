...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'toLoveGov'
        db.create_table('modernpolitics_tolovegov', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('who', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('from_where', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ))
        db.send_create_signal('modernpolitics', ['toLoveGov'])


    def backwards(self, orm):
        # Deleting model 'toLoveGov'
        db.delete_table('modernpolitics_tolovegov')
