...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RankedContent'
        db.create_table('modernpolitics_rankedcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ranked_by', to=orm['modernpolitics.Content'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ranked_it', to=orm['modernpolitics.UserProfile'])),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('modernpolitics', ['RankedContent'])

        # Adding model 'SeenContent'
        db.create_table('modernpolitics_seencontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seen_by', to=orm['modernpolitics.Content'])),
            ('seen', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('modernpolitics', ['SeenContent'])

        # Adding field 'UserProfile.last_updated_hot_feed'
        db.add_column('modernpolitics_userprofile', 'last_updated_hot_feed',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field seen_content on 'UserProfile'
        db.create_table('modernpolitics_userprofile_seen_content', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('seencontent', models.ForeignKey(orm['modernpolitics.seencontent'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_seen_content', ['userprofile_id', 'seencontent_id'])

        # Adding M2M table for field stale_content on 'UserProfile'
        db.create_table('modernpolitics_userprofile_stale_content', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('content', models.ForeignKey(orm['modernpolitics.content'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_stale_content', ['userprofile_id', 'content_id'])

        # Adding field 'ClientAnalytics.test_run'
        db.add_column('modernpolitics_clientanalytics', 'test_run',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RankedContent'
        db.delete_table('modernpolitics_rankedcontent')

        # Deleting model 'SeenContent'
        db.delete_table('modernpolitics_seencontent')

        # Deleting field 'UserProfile.last_updated_hot_feed'
        db.delete_column('modernpolitics_userprofile', 'last_updated_hot_feed')

        # Removing M2M table for field seen_content on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_seen_content')

        # Removing M2M table for field stale_content on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_stale_content')

        # Deleting field 'ClientAnalytics.test_run'
        db.delete_column('modernpolitics_clientanalytics', 'test_run')
