...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Politician.num_supporters'
        db.add_column('modernpolitics_politician', 'num_supporters',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Politician.num_messages'
        db.add_column('modernpolitics_politician', 'num_messages',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Politician.num_supporters'
        db.delete_column('modernpolitics_politician', 'num_supporters')

        # Deleting field 'Politician.num_messages'
        db.delete_column('modernpolitics_politician', 'num_messages')
