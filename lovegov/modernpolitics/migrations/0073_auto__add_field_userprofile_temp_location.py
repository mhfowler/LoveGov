...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.temp_location'
        db.add_column('modernpolitics_userprofile', 'temp_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='temp_users', null=True, to=orm['modernpolitics.PhysicalAddress']),
                      keep_default=False)

        # Adding M2M table for field old_locations on 'UserProfile'
        db.create_table('modernpolitics_userprofile_old_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('physicaladdress', models.ForeignKey(orm['modernpolitics.physicaladdress'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_old_locations', ['userprofile_id', 'physicaladdress_id'])


    def backwards(self, orm):
        # Deleting field 'UserProfile.temp_location'
        db.delete_column('modernpolitics_userprofile', 'temp_location_id')

        # Removing M2M table for field old_locations on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_old_locations')
