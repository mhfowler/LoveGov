...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Party'
        db.create_table('modernpolitics_party', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Group'], unique=True, primary_key=True)),
            ('party_type', self.gf('django.db.models.fields.CharField')(default='D', max_length=1)),
            ('party_label', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
        ))
        db.send_create_signal('modernpolitics', ['Party'])

        # Adding M2M table for field parties on 'UserProfile'
        db.create_table('modernpolitics_userprofile_parties', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('party', models.ForeignKey(orm['modernpolitics.party'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_parties', ['userprofile_id', 'party_id'])


    def backwards(self, orm):
        # Deleting model 'Party'
        db.delete_table('modernpolitics_party')

        # Removing M2M table for field parties on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_parties')
    ...
    models = {
        ...
        'modernpolitics.basicinfo': {
            ...
            'bio': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
