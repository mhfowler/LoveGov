...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.my_connections'
        db.delete_column('modernpolitics_userprofile', 'my_connections')


    def backwards(self, orm):
        # Adding field 'UserProfile.my_connections'
        db.add_column('modernpolitics_userprofile', 'my_connections',
