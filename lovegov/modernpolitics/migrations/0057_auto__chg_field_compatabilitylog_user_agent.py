...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompatabilityLog.user_agent'
        db.alter_column('modernpolitics_compatabilitylog', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'CompatabilityLog.user_agent'
        db.alter_column('modernpolitics_compatabilitylog', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=50))
