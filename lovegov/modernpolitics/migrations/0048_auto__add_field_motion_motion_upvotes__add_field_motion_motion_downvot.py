...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Motion.motion_upvotes'
        db.add_column('modernpolitics_motion', 'motion_upvotes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Motion.motion_downvotes'
        db.add_column('modernpolitics_motion', 'motion_downvotes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Motion.motion_upvotes'
        db.delete_column('modernpolitics_motion', 'motion_upvotes')

        # Deleting field 'Motion.motion_downvotes'
        db.delete_column('modernpolitics_motion', 'motion_downvotes')
