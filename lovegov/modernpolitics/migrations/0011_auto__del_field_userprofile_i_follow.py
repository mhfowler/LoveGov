...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.i_follow'
        db.delete_column('modernpolitics_userprofile', 'i_follow_id')


    def backwards(self, orm):
        # Adding field 'UserProfile.i_follow'
        db.add_column('modernpolitics_userprofile', 'i_follow',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='i_follow', null=True, to=orm['modernpolitics.Group']),
                      keep_default=False)
