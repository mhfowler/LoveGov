...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LoveGovAlias'
        db.create_table('modernpolitics_lovegovalias', (
        ...
        db.send_create_signal('modernpolitics', ['LoveGovAlias'])


    def backwards(self, orm):
        # Deleting model 'LoveGovAlias'
        db.delete_table('modernpolitics_lovegovalias')
