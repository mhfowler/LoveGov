...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailSent'
        db.create_table('modernpolitics_emailsent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('which', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('when', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('modernpolitics', ['EmailSent'])


    def backwards(self, orm):
        # Deleting model 'EmailSent'
        db.delete_table('modernpolitics_emailsent')
