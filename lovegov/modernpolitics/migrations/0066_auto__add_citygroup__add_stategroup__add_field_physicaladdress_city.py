...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modernpolitics_stategroup', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Group'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['StateGroup'])

        # Adding field 'PhysicalAddress.city'
        db.add_column('modernpolitics_physicaladdress', 'city',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('modernpolitics_stategroup')

        # Deleting field 'PhysicalAddress.city'
        db.delete_column('modernpolitics_physicaladdress', 'city')
