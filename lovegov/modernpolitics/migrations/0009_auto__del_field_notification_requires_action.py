...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.requires_action'
        db.delete_column('modernpolitics_notification', 'requires_action')


    def backwards(self, orm):
        # Adding field 'Notification.requires_action'
        db.add_column('modernpolitics_notification', 'requires_action',
