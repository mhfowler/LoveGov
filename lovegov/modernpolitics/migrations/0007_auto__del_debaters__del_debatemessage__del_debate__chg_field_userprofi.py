...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.email_notification_setting'
        db.alter_column('modernpolitics_userprofile', 'email_notification_setting', self.gf('lovegov.modernpolitics.custom_fields.ListField')())

        # Changing field 'UserProfile.user_notification_setting'
        db.alter_column('modernpolitics_userprofile', 'user_notification_setting', self.gf('lovegov.modernpolitics.custom_fields.ListField')())

        # Changing field 'UserProfile.content_notification_setting'
        db.alter_column('modernpolitics_userprofile', 'content_notification_setting', self.gf('lovegov.modernpolitics.custom_fields.ListField')())

        # Changing field 'BasicInfo.address'
        db.alter_column('modernpolitics_basicinfo', 'address', self.gf('lovegov.modernpolitics.custom_fields.ListField')())

        # Changing field 'BasicInfo.url'
        db.alter_column('modernpolitics_basicinfo', 'url', self.gf('lovegov.modernpolitics.custom_fields.ListField')())

        # Changing field 'Response.answers'
        db.alter_column('modernpolitics_response', 'answers', self.gf('lovegov.modernpolitics.custom_fields.ListField')())

        # Changing field 'CustomNotificationSetting.alerts'
        db.alter_column('modernpolitics_customnotificationsetting', 'alerts', self.gf('lovegov.modernpolitics.custom_fields.ListField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.email_notification_setting'
        db.alter_column('modernpolitics_userprofile', 'email_notification_setting', self.gf('lovegov.beta.modernpolitics.custom_fields.ListField')())

        # Changing field 'UserProfile.user_notification_setting'
        db.alter_column('modernpolitics_userprofile', 'user_notification_setting', self.gf('lovegov.beta.modernpolitics.custom_fields.ListField')())

        # Changing field 'UserProfile.content_notification_setting'
        db.alter_column('modernpolitics_userprofile', 'content_notification_setting', self.gf('lovegov.beta.modernpolitics.custom_fields.ListField')())

        # Changing field 'BasicInfo.address'
        db.alter_column('modernpolitics_basicinfo', 'address', self.gf('lovegov.beta.modernpolitics.custom_fields.ListField')())

        # Changing field 'BasicInfo.url'
        db.alter_column('modernpolitics_basicinfo', 'url', self.gf('lovegov.beta.modernpolitics.custom_fields.ListField')())

        # Changing field 'Response.answers'
        db.alter_column('modernpolitics_response', 'answers', self.gf('lovegov.beta.modernpolitics.custom_fields.ListField')())

        # Changing field 'CustomNotificationSetting.alerts'
        db.alter_column('modernpolitics_customnotificationsetting', 'alerts', self.gf('lovegov.beta.modernpolitics.custom_fields.ListField')())
