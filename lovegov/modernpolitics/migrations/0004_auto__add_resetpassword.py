...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modernpolitics_resetpassword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('userProfile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'])),
            ('email_code', self.gf('django.db.models.fields.CharField')(max_length=75)),
        ))
        db.send_create_signal('modernpolitics', ['ResetPassword'])


    def backwards(self, orm):
        # Deleting model 'ResetPassword'
        db.delete_table('modernpolitics_resetpassword')
