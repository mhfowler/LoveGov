...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.hidden'
        db.add_column('modernpolitics_group', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Group.autogen'
        db.add_column('modernpolitics_group', 'autogen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Group.hidden'
        db.delete_column('modernpolitics_group', 'hidden')

        # Deleting field 'Group.autogen'
        db.delete_column('modernpolitics_group', 'autogen')
