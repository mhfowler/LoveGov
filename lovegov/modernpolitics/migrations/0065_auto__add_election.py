...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modernpolitics_election', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Group'], unique=True, primary_key=True)),
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='elections_won', null=True, to=orm['modernpolitics.UserProfile'])),
            ('office', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Office'], null=True)),
            ('election_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('modernpolitics', ['Election'])
        ...
        # Adding M2M table for field commenters on 'Content'
        db.create_table('modernpolitics_content_commenters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('content', models.ForeignKey(orm['modernpolitics.content'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_content_commenters', ['content_id', 'userprofile_id'])


    def backwards(self, orm):
        # Deleting model 'Election'
        db.delete_table('modernpolitics_election')

        # Removing M2M table for field running on 'Election'
        db.delete_table('modernpolitics_election_running')

        # Removing M2M table for field commenters on 'Content'
        db.delete_table('modernpolitics_content_commenters')
