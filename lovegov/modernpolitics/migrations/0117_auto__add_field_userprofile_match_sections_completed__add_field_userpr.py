...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.match_sections_completed'
        db.add_column('modernpolitics_userprofile', 'match_sections_completed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=26),
                      keep_default=False)

        # Adding field 'UserProfile.show_welcome'
        db.add_column('modernpolitics_userprofile', 'show_welcome',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.match_sections_completed'
        db.delete_column('modernpolitics_userprofile', 'match_sections_completed')

        # Deleting field 'UserProfile.show_welcome'
        db.delete_column('modernpolitics_userprofile', 'show_welcome')
    ...
    models = {
        ...
        'modernpolitics.userprofile': {
            ...
            'match_sections_completed': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '26'}),
            ...
            'normal': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'show_welcome': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
