...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Petition.current'
        db.add_column('modernpolitics_petition', 'current',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Petition.goal'
        db.add_column('modernpolitics_petition', 'goal',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'Petition.p_level'
        db.add_column('modernpolitics_petition', 'p_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Content.level'
        db.delete_column('modernpolitics_content', 'level')

        # Adding field 'Content.scale'
        db.add_column('modernpolitics_content', 'scale',
                      self.gf('django.db.models.fields.CharField')(default='W', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Petition.current'
        db.delete_column('modernpolitics_petition', 'current')

        # Deleting field 'Petition.goal'
        db.delete_column('modernpolitics_petition', 'goal')

        # Deleting field 'Petition.p_level'
        db.delete_column('modernpolitics_petition', 'p_level')

        # Adding field 'Content.level'
        db.add_column('modernpolitics_content', 'level',
                      self.gf('django.db.models.fields.CharField')(default='W', max_length=1),
                      keep_default=False)

        # Deleting field 'Content.scale'
        db.delete_column('modernpolitics_content', 'scale')
