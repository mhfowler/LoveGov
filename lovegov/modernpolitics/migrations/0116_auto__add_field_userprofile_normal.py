...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.normal'
        db.add_column('modernpolitics_userprofile', 'normal',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.normal'
        db.delete_column('modernpolitics_userprofile', 'normal')
