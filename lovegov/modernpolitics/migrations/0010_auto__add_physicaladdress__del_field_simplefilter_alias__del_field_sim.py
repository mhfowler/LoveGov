...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhysicalAddress'
        db.create_table('modernpolitics_physicaladdress', (
        ...
        db.send_create_signal('modernpolitics', ['PhysicalAddress'])

        # Deleting field 'SimpleFilter.alias'
        db.delete_column('modernpolitics_simplefilter', 'alias')

        # Deleting field 'SimpleFilter.just_created_by_group'
        db.delete_column('modernpolitics_simplefilter', 'just_created_by_group')

        # Adding field 'SimpleFilter.name'
        db.add_column('modernpolitics_simplefilter', 'name',
                      self.gf('django.db.models.fields.CharField')(default='filter', max_length=200),
                      keep_default=False)

        # Adding field 'SimpleFilter.levels'
        db.add_column('modernpolitics_simplefilter', 'levels',
                      self.gf('lovegov.modernpolitics.custom_fields.ListField')(default=[]),
                      keep_default=False)

        # Adding field 'SimpleFilter.submissions_only'
        db.add_column('modernpolitics_simplefilter', 'submissions_only',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SimpleFilter.display'
        db.add_column('modernpolitics_simplefilter', 'display',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=1),
                      keep_default=False)

        # Adding field 'SimpleFilter.location'
        db.add_column('modernpolitics_simplefilter', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.PhysicalAddress'], null=True),
                      keep_default=False)

        # Adding field 'UserProfile.location'
        db.add_column('modernpolitics_userprofile', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.PhysicalAddress'], null=True),
                      keep_default=False)

        # Adding M2M table for field my_filters on 'UserProfile'
        db.create_table('modernpolitics_userprofile_my_filters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('simplefilter', models.ForeignKey(orm['modernpolitics.simplefilter'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_my_filters', ['userprofile_id', 'simplefilter_id'])

        # Adding field 'Notification.recent_user'
        db.add_column('modernpolitics_notification', 'recent_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='mostrecentuser', null=True, to=orm['modernpolitics.UserProfile']),
                      keep_default=False)


        # Changing field 'Content.location'
        db.alter_column('modernpolitics_content', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.PhysicalAddress'], null=True))

    def backwards(self, orm):
        # Deleting model 'PhysicalAddress'
        db.delete_table('modernpolitics_physicaladdress')

        # Adding field 'SimpleFilter.alias'
        db.add_column('modernpolitics_simplefilter', 'alias',
                      self.gf('django.db.models.fields.CharField')(default='filter', max_length=200),
                      keep_default=False)

        # Adding field 'SimpleFilter.just_created_by_group'
        db.add_column('modernpolitics_simplefilter', 'just_created_by_group',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'SimpleFilter.name'
        db.delete_column('modernpolitics_simplefilter', 'name')

        # Deleting field 'SimpleFilter.levels'
        db.delete_column('modernpolitics_simplefilter', 'levels')

        # Deleting field 'SimpleFilter.submissions_only'
        db.delete_column('modernpolitics_simplefilter', 'submissions_only')

        # Deleting field 'SimpleFilter.display'
        db.delete_column('modernpolitics_simplefilter', 'display')

        # Deleting field 'SimpleFilter.location'
        db.delete_column('modernpolitics_simplefilter', 'location_id')

        # Deleting field 'UserProfile.location'
        db.delete_column('modernpolitics_userprofile', 'location_id')

        # Removing M2M table for field my_filters on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_my_filters')

        # Deleting field 'Notification.recent_user'
        db.delete_column('modernpolitics_notification', 'recent_user_id')


        # Changing field 'Content.location'
        db.alter_column('modernpolitics_content', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserPhysicalAddress'], null=True))
    ...
    models = {
        ...
        'modernpolitics.action': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': '154', 'to': "orm['modernpolitics.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'modernpolitics.basicinfo': {
            ...
            'address': ('lovegov.modernpolitics.custom_fields.ListField', [], {}),
            ...
            'url': ('lovegov.modernpolitics.custom_fields.ListField', [], {}),
        ...
        'modernpolitics.simplefilter': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modernpolitics.PhysicalAddress']", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'filter'", 'max_length': '200'}),
