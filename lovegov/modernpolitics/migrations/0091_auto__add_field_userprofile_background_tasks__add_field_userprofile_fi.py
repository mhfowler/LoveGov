...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.background_tasks'
        db.add_column('modernpolitics_userprofile', 'background_tasks',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.finished_tasks'
        db.add_column('modernpolitics_userprofile', 'finished_tasks',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.background_tasks'
        db.delete_column('modernpolitics_userprofile', 'background_tasks')

        # Deleting field 'UserProfile.finished_tasks'
        db.delete_column('modernpolitics_userprofile', 'finished_tasks')
