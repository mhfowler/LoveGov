...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OfficeHeld'
        db.create_table('modernpolitics_officeheld', (
            ...
            ('office', self.gf('django.db.models.fields.related.ForeignKey')(related_name='office', to=orm['modernpolitics.Office'])),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('election', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('modernpolitics', ['OfficeHeld'])

        # Adding M2M table for field congress_sessions on 'OfficeHeld'
        db.create_table('modernpolitics_officeheld_congress_sessions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('officeheld', models.ForeignKey(orm['modernpolitics.officeheld'], null=False)),
            ('congresssession', models.ForeignKey(orm['modernpolitics.congresssession'], null=False))
        ))
        db.create_unique('modernpolitics_officeheld_congress_sessions', ['officeheld_id', 'congresssession_id'])
        ...
        db.create_table('modernpolitics_legislation', (
            ...
            ('congress_session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.CongressSession'])),
            ('bill_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('bill_number', self.gf('django.db.models.fields.IntegerField')()),
            ('bill_updated', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('bill_introduced', self.gf('django.db.models.fields.DateField')(null=True)),
            ('state_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('state_text', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('full_title', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
            ('sponsor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sponsored_legislation', null=True, to=orm['modernpolitics.UserProfile'])),
            ('bill_summary', self.gf('django.db.models.fields.TextField')(max_length=400000, null=True)),
        ))
        db.send_create_signal('modernpolitics', ['Legislation'])

        # Adding M2M table for field committees on 'Legislation'
        db.create_table('modernpolitics_legislation_committees', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('legislation', models.ForeignKey(orm['modernpolitics.legislation'], null=False)),
            ('committee', models.ForeignKey(orm['modernpolitics.committee'], null=False))
        ))
        db.create_unique('modernpolitics_legislation_committees', ['legislation_id', 'committee_id'])
        ...
        # Adding M2M table for field bill_subjects on 'Legislation'
        db.create_table('modernpolitics_legislation_bill_subjects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('legislation', models.ForeignKey(orm['modernpolitics.legislation'], null=False)),
            ('legislationsubject', models.ForeignKey(orm['modernpolitics.legislationsubject'], null=False))
        ))
        db.create_unique('modernpolitics_legislation_bill_subjects', ['legislation_id', 'legislationsubject_id'])

        # Adding model 'LegislationVote'
        db.create_table('modernpolitics_legislationvote', (
            ('legislationaction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.LegislationAction'], unique=True, primary_key=True)),
            ('how', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ...
        # Adding model 'CongressSession'
        db.create_table('modernpolitics_congresssession', (
            ('session', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['CongressSession'])

        # Adding model 'LegislationSubject'
        db.create_table('modernpolitics_legislationsubject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('modernpolitics', ['LegislationSubject'])

        # Adding model 'CongressRoll'
        db.create_table('modernpolitics_congressroll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('where', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.CongressSession'])),
            ...
            ('aye', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('nay', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('nv', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('present', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('required', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('result', self.gf('django.db.models.fields.CharField')(max_length=80, null=True)),
        ...
        db.create_table('modernpolitics_legislationcosponsor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('legislation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='legislation_cosponsors', to=orm['modernpolitics.Legislation'])),
            ('cosponsor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'])),
            ('date', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal('modernpolitics', ['LegislationCosponsor'])

        # Adding model 'CongressVote'
        db.create_table('modernpolitics_congressvote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('roll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['modernpolitics.CongressRoll'])),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='congress_votes', to=orm['modernpolitics.UserProfile'])),
            ('votekey', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('votevalue', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('modernpolitics', ['CongressVote'])
        ...
        db.create_table('modernpolitics_committee', (
            ...
            ('committee_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ...
        # Adding model 'CommitteeJoined'
        db.create_table('modernpolitics_committeejoined', (
            ('groupjoined_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.GroupJoined'], unique=True, primary_key=True)),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
        ))
        db.send_create_signal('modernpolitics', ['CommitteeJoined'])

        # Adding M2M table for field congress_sessions on 'CommitteeJoined'
        db.create_table('modernpolitics_committeejoined_congress_sessions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('committeejoined', models.ForeignKey(orm['modernpolitics.committeejoined'], null=False)),
            ('congresssession', models.ForeignKey(orm['modernpolitics.congresssession'], null=False))
        ))
        db.create_unique('modernpolitics_committeejoined_congress_sessions', ['committeejoined_id', 'congresssession_id'])

        # Adding model 'LegislationAmendment'
        db.create_table('modernpolitics_legislationamendment', (
            ('content_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Content'], unique=True, primary_key=True)),
            ('legislation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='legislation_amendments', to=orm['modernpolitics.Legislation'])),
            ('congress_session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='session_amendments', to=orm['modernpolitics.CongressSession'])),
            ('amendment_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('amendment_number', self.gf('django.db.models.fields.IntegerField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ...
            ('status_text', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('sponsor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=50000, null=True)),
            ('purpose', self.gf('django.db.models.fields.TextField')(max_length=5000, null=True)),
        ...
        # Adding model 'LegislationReference'
        db.create_table('modernpolitics_legislationreference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('ref', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('modernpolitics', ['LegislationReference'])
        ...
        db.create_table('modernpolitics_legislationaction', (
            ...
            ('legislation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='legislation_actions', null=True, to=orm['modernpolitics.Legislation'])),
            ('amendment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='amendment_actions', null=True, to=orm['modernpolitics.LegislationAmendment'])),
            ('committee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='legislation_activity', null=True, to=orm['modernpolitics.Committee'])),
            ('state', self.gf('django.db.models.fields.TextField')(max_length=100, null=True)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=500, null=True)),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('modernpolitics', ['LegislationAction'])

        # Adding M2M table for field references on 'LegislationAction'
        db.create_table('modernpolitics_legislationaction_references', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('legislationaction', models.ForeignKey(orm['modernpolitics.legislationaction'], null=False)),
            ('legislationreference', models.ForeignKey(orm['modernpolitics.legislationreference'], null=False))
        ))
        db.create_unique('modernpolitics_legislationaction_references', ['legislationaction_id', 'legislationreference_id'])

        # Adding M2M table for field offices_held on 'UserProfile'
        db.create_table('modernpolitics_userprofile_offices_held', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('officeheld', models.ForeignKey(orm['modernpolitics.officeheld'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_offices_held', ['userprofile_id', 'officeheld_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'OfficeHeld'
        db.delete_table('modernpolitics_officeheld')

        # Removing M2M table for field congress_sessions on 'OfficeHeld'
        db.delete_table('modernpolitics_officeheld_congress_sessions')

        # Deleting model 'Legislation'
        db.delete_table('modernpolitics_legislation')

        # Removing M2M table for field committees on 'Legislation'
        db.delete_table('modernpolitics_legislation_committees')

        # Removing M2M table for field bill_relation on 'Legislation'
        db.delete_table('modernpolitics_legislation_bill_relation')

        # Removing M2M table for field bill_subjects on 'Legislation'
        db.delete_table('modernpolitics_legislation_bill_subjects')

        # Deleting model 'LegislationVote'
        db.delete_table('modernpolitics_legislationvote')

        # Deleting model 'CongressSession'
        db.delete_table('modernpolitics_congresssession')

        # Deleting model 'LegislationSubject'
        db.delete_table('modernpolitics_legislationsubject')
        ...
        # Deleting model 'CongressVote'
        db.delete_table('modernpolitics_congressvote')
        ...
        # Deleting model 'CommitteeJoined'
        db.delete_table('modernpolitics_committeejoined')

        # Removing M2M table for field congress_sessions on 'CommitteeJoined'
        db.delete_table('modernpolitics_committeejoined_congress_sessions')
        ...
        # Deleting model 'LegislationReference'
        db.delete_table('modernpolitics_legislationreference')

        # Deleting model 'LegislationAction'
        db.delete_table('modernpolitics_legislationaction')

        # Removing M2M table for field references on 'LegislationAction'
        db.delete_table('modernpolitics_legislationaction_references')

        # Removing M2M table for field offices_held on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_offices_held')
    ...
    models = {
        ...
        'modernpolitics.congressroll': {
            ...
            'required': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
        ...
        'modernpolitics.congressvote': {
            ...
            'votevalue': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        ...
        'modernpolitics.legislation': {
            ...
            'content_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['modernpolitics.Content']", 'unique': 'True', 'primary_key': 'True'}),
            'full_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
        ...
        'modernpolitics.legislationaction': {
            ...
            'text': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True'})
        },
        ...
        'modernpolitics.officeheld': {
            ...
            'office': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'office'", 'to': "orm['modernpolitics.Office']"}),
        ...
        'modernpolitics.userprofile': {
            ...
            'offices_held': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'office_holders'", 'symmetrical': 'False', 'to': "orm['modernpolitics.OfficeHeld']"}),
