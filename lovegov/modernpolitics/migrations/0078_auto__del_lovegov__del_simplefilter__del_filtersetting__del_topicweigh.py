...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'SimpleFilter'
        db.delete_table('modernpolitics_simplefilter')

        # Removing M2M table for field topics on 'SimpleFilter'
        db.delete_table('modernpolitics_simplefilter_topics')

        # Removing M2M table for field groups on 'SimpleFilter'
        db.delete_table('modernpolitics_simplefilter_groups')
        ...
        # Deleting field 'UserProfile.filter_setting'
        db.delete_column('modernpolitics_userprofile', 'filter_setting_id')

        # Deleting field 'UserProfile.evolve'
        db.delete_column('modernpolitics_userprofile', 'evolve')
        ...
        # Adding field 'Content.hot_score'
        db.add_column('modernpolitics_content', 'hot_score',
    ...
    def backwards(self, orm):
        ...
        # Adding model 'SimpleFilter'
        db.create_table('modernpolitics_simplefilter', (
            ('ranking', self.gf('django.db.models.fields.CharField')(default='H', max_length=1)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True)),
            ('levels', self.gf('lovegov.modernpolitics.custom_fields.ListField')(default=[])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('types', self.gf('lovegov.modernpolitics.custom_fields.ListField')()),
            ('name', self.gf('django.db.models.fields.CharField')(default='default', max_length=200)),
            ('submissions_only', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.PhysicalAddress'], null=True)),
            ('created_when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('display', self.gf('django.db.models.fields.CharField')(default='P', max_length=1)),
        ))
        db.send_create_signal('modernpolitics', ['SimpleFilter'])

        # Adding M2M table for field topics on 'SimpleFilter'
        db.create_table('modernpolitics_simplefilter_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique('modernpolitics_simplefilter_topics', ['simplefilter_id', 'topic_id'])

        # Adding M2M table for field groups on 'SimpleFilter'
        db.create_table('modernpolitics_simplefilter_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('simplefilter', models.ForeignKey(orm['modernpolitics.simplefilter'], null=False)),
            ('group', models.ForeignKey(orm['modernpolitics.group'], null=False))
        ))
        db.create_unique('modernpolitics_simplefilter_groups', ['simplefilter_id', 'group_id'])

        # Adding model 'FilterSetting'
        db.create_table('modernpolitics_filtersetting', (
            ('hot_window', self.gf('django.db.models.fields.IntegerField')(default=3)),
        ...
        # Adding field 'UserProfile.filter_setting'
        db.add_column('modernpolitics_userprofile', 'filter_setting',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.FilterSetting'], null=True),
                      keep_default=False)

        # Adding field 'UserProfile.evolve'
        db.add_column('modernpolitics_userprofile', 'evolve',
        ...
        # Deleting field 'Content.hot_score'
        db.delete_column('modernpolitics_content', 'hot_score')
