...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('modernpolitics_userprofile', 'bio', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'UserProfile.political_role'
        db.alter_column('modernpolitics_userprofile', 'political_role', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'UserProfile.ethnicity'
        db.alter_column('modernpolitics_userprofile', 'ethnicity', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'UserProfile.middle_name'
        db.alter_column('modernpolitics_userprofile', 'middle_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'UserProfile.religion'
        db.alter_column('modernpolitics_userprofile', 'religion', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'UserProfile.zipcode'
        db.alter_column('modernpolitics_userprofile', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'UserProfile.state'
        db.alter_column('modernpolitics_userprofile', 'state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'UserProfile.party'
        db.alter_column('modernpolitics_userprofile', 'party', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'UserProfile.nick_name'
        db.alter_column('modernpolitics_userprofile', 'nick_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'UserProfile.gender'
        db.alter_column('modernpolitics_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.bio'
        db.alter_column('modernpolitics_userprofile', 'bio', self.gf('django.db.models.fields.CharField')(default='', max_length=150))

        # Changing field 'UserProfile.political_role'
        db.alter_column('modernpolitics_userprofile', 'political_role', self.gf('django.db.models.fields.CharField')(default='', max_length=1))

        # Changing field 'UserProfile.ethnicity'
        db.alter_column('modernpolitics_userprofile', 'ethnicity', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'UserProfile.middle_name'
        db.alter_column('modernpolitics_userprofile', 'middle_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'UserProfile.religion'
        db.alter_column('modernpolitics_userprofile', 'religion', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'UserProfile.zipcode'
        db.alter_column('modernpolitics_userprofile', 'zipcode', self.gf('django.db.models.fields.CharField')(default='', max_length=15))

        # Changing field 'UserProfile.state'
        db.alter_column('modernpolitics_userprofile', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

        # Changing field 'UserProfile.party'
        db.alter_column('modernpolitics_userprofile', 'party', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'UserProfile.nick_name'
        db.alter_column('modernpolitics_userprofile', 'nick_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'UserProfile.gender'
        db.alter_column('modernpolitics_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(default='', max_length=1))
    ...
    models = {
        ...
        'modernpolitics.content': {
            ...
            'scale': ('django.db.models.fields.CharField', [], {'default': "'W'", 'max_length': '1'}),
        ...
        'modernpolitics.petition': {
            ...
            'p_level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
