...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RunningForAction'
        db.create_table('modernpolitics_runningforaction', (
            ...
            ('election', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Election'])),
            ('modifier', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('modernpolitics', ['RunningForAction'])

        # Adding field 'MessagedAction.phone_number'
        db.add_column('modernpolitics_messagedaction', 'phone_number',
    ...
    def backwards(self, orm):
        # Deleting model 'RunningForAction'
        db.delete_table('modernpolitics_runningforaction')

        # Deleting field 'MessagedAction.phone_number'
        db.delete_column('modernpolitics_messagedaction', 'phone_number')
