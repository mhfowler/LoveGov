...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Supported'
        db.delete_table('modernpolitics_supported')
        ...
        # Removing M2M table for field anon_users on 'Notification'
        db.delete_table('modernpolitics_notification_anon_users')

        # Deleting model 'Created'
        db.delete_table('modernpolitics_created')

        # Deleting model 'Messaged'
        db.delete_table('modernpolitics_messaged')

        # Deleting field 'GroupJoined.ever_member'
        db.delete_column('modernpolitics_groupjoined', 'ever_member')

        # Deleting field 'Relationship.when'
        db.delete_column('modernpolitics_relationship', 'when')

        # Adding field 'Relationship.created_when'
        db.add_column('modernpolitics_relationship', 'created_when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 20, 0, 0), blank=True),
                      keep_default=False)

        # Removing M2M table for field group_content on 'Group'
        db.delete_table('modernpolitics_group_group_content')

        # Adding M2M table for field pinned_content on 'Group'
        db.create_table('modernpolitics_group_pinned_content', (
        ...
        db.create_unique('modernpolitics_group_pinned_content', ['group_id', 'content_id'])

        # Adding field 'Discussion.user_post'
        db.add_column('modernpolitics_discussion', 'user_post',
    ...
    def backwards(self, orm):
        ...
        # Adding model 'Supported'
        db.create_table('modernpolitics_supported', (
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('modernpolitics', ['Supported'])
        ...
        db.create_table('modernpolitics_notification', (
            ...
            ('privacy', self.gf('django.db.models.fields.CharField')(default='PUB', max_length=3)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('recent_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mostrecentuser', null=True, to=orm['modernpolitics.UserProfile'])),
        ...
        # Adding M2M table for field anon_users on 'Notification'
        db.create_table('modernpolitics_notification_anon_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notification', models.ForeignKey(orm['modernpolitics.notification'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_notification_anon_users', ['notification_id', 'userprofile_id'])
        ...
        # Adding model 'Messaged'
        db.create_table('modernpolitics_messaged', (
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('uurelationship_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.UURelationship'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['Messaged'])
        ...
        # Adding field 'Relationship.when'
        db.add_column('modernpolitics_relationship', 'when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 20, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Relationship.created_when'
        db.delete_column('modernpolitics_relationship', 'created_when')
        ...
        # Removing M2M table for field pinned_content on 'Group'
        db.delete_table('modernpolitics_group_pinned_content')

        # Deleting field 'Discussion.user_post'
        db.delete_column('modernpolitics_discussion', 'user_post')
