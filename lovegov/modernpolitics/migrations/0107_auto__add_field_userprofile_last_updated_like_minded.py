...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_updated_like_minded'
        db.add_column('modernpolitics_userprofile', 'last_updated_like_minded',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_updated_like_minded'
        db.delete_column('modernpolitics_userprofile', 'last_updated_like_minded')
