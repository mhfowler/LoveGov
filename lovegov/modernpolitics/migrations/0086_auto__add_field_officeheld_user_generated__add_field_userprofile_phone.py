...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfficeHeld.user_generated'
        db.add_column('modernpolitics_officeheld', 'user_generated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.phone_number'
        db.add_column('modernpolitics_userprofile', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.running_for'
        db.add_column('modernpolitics_userprofile', 'running_for',
    ...
    def backwards(self, orm):
        # Deleting field 'OfficeHeld.user_generated'
        db.delete_column('modernpolitics_officeheld', 'user_generated')

        # Deleting field 'UserProfile.phone_number'
        db.delete_column('modernpolitics_userprofile', 'phone_number')
