...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompatabilityLog'
        db.create_table('modernpolitics_compatabilitylog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True)),
            ('incompatible', self.gf('lovegov.modernpolitics.custom_fields.ListField')(default=[])),
            ('page', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('ipaddress', self.gf('django.db.models.fields.IPAddressField')(default='255.255.255.255', max_length=15, null=True)),
            ('user_agent', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('modernpolitics', ['CompatabilityLog'])


    def backwards(self, orm):
        # Deleting model 'CompatabilityLog'
        db.delete_table('modernpolitics_compatabilitylog')
    ...
    models = {
        ...
        'modernpolitics.compatabilitylog': {
            ...
            'user_agent': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
