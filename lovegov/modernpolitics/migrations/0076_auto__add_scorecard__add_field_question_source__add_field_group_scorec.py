...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modernpolitics_scorecard', (
            ...
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scorecards', null=True, to=orm['modernpolitics.Group'])),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Poll'])),
            ('scorecard_view', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.WorldView'])),
            ('full_text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('modernpolitics', ['Scorecard'])

        # Adding M2M table for field politicians on 'Scorecard'
        db.create_table('modernpolitics_scorecard_politicians', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scorecard', models.ForeignKey(orm['modernpolitics.scorecard'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_scorecard_politicians', ['scorecard_id', 'userprofile_id'])
        ...
        # Adding field 'Group.scorecard'
        db.add_column('modernpolitics_group', 'scorecard',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='group_origins', null=True, to=orm['modernpolitics.Scorecard']),
                      keep_default=False)

        # Adding field 'Content.last_answered'
        db.add_column('modernpolitics_content', 'last_answered',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('modernpolitics_scorecard')

        # Removing M2M table for field politicians on 'Scorecard'
        db.delete_table('modernpolitics_scorecard_politicians')

        # Deleting field 'Question.source'
        db.delete_column('modernpolitics_question', 'source')

        # Deleting field 'Group.scorecard'
        db.delete_column('modernpolitics_group', 'scorecard_id')

        # Deleting field 'Content.last_answered'
        db.delete_column('modernpolitics_content', 'last_answered')
