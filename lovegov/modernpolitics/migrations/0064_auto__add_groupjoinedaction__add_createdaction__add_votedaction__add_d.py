...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupJoinedAction'
        db.create_table('modernpolitics_groupjoinedaction', (
            ...
            ('group_joined', self.gf('django.db.models.fields.related.ForeignKey')(related_name='joined_actions', to=orm['modernpolitics.GroupJoined'])),
            ('modifier', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('modernpolitics', ['GroupJoinedAction'])

        # Adding model 'CreatedAction'
        db.create_table('modernpolitics_createdaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Content'])),
        ))
        db.send_create_signal('modernpolitics', ['CreatedAction'])

        # Adding model 'VotedAction'
        db.create_table('modernpolitics_votedaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Content'])),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('modernpolitics', ['VotedAction'])

        # Adding model 'DeletedAction'
        db.create_table('modernpolitics_deletedaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Content'])),
        ))
        db.send_create_signal('modernpolitics', ['DeletedAction'])
        ...
        db.create_table('modernpolitics_action', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['modernpolitics.UserProfile'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='actions', to=orm['modernpolitics.UserProfile'])),
        ...
        db.create_table('modernpolitics_notification', (
            ...
            ('privacy', self.gf('django.db.models.fields.CharField')(default='PUB', max_length=3)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['modernpolitics.UserProfile'])),
            ('notify_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['modernpolitics.UserProfile'])),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['modernpolitics.Action'])),
            ('viewed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('modernpolitics', ['Notification'])

        # Adding M2M table for field agg_actions on 'Notification'
        db.create_table('modernpolitics_notification_agg_actions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notification', models.ForeignKey(orm['modernpolitics.notification'], null=False)),
            ('action', models.ForeignKey(orm['modernpolitics.action'], null=False))
        ))
        db.create_unique('modernpolitics_notification_agg_actions', ['notification_id', 'action_id'])

        # Adding model 'SignedAction'
        db.create_table('modernpolitics_signedaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('petition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Petition'])),
        ))
        db.send_create_signal('modernpolitics', ['SignedAction'])

        # Adding model 'SharedAction'
        db.create_table('modernpolitics_sharedaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Content'])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True)),
            ('to_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shared_to_actions', null=True, to=orm['modernpolitics.Group'])),
        ))
        db.send_create_signal('modernpolitics', ['SharedAction'])

        # Adding model 'UserFollowAction'
        db.create_table('modernpolitics_userfollowaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('user_follow', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follow_actions', to=orm['modernpolitics.UserFollow'])),
            ('modifier', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('modernpolitics', ['UserFollowAction'])

        # Adding model 'EditedAction'
        db.create_table('modernpolitics_editedaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Content'])),
        ))
        db.send_create_signal('modernpolitics', ['EditedAction'])


    def backwards(self, orm):
        # Deleting model 'GroupJoinedAction'
        db.delete_table('modernpolitics_groupjoinedaction')

        # Deleting model 'CreatedAction'
        db.delete_table('modernpolitics_createdaction')

        # Deleting model 'VotedAction'
        db.delete_table('modernpolitics_votedaction')

        # Deleting model 'DeletedAction'
        db.delete_table('modernpolitics_deletedaction')
        ...
        # Removing M2M table for field agg_actions on 'Notification'
        db.delete_table('modernpolitics_notification_agg_actions')

        # Deleting model 'SignedAction'
        db.delete_table('modernpolitics_signedaction')

        # Deleting model 'SharedAction'
        db.delete_table('modernpolitics_sharedaction')

        # Deleting model 'UserFollowAction'
        db.delete_table('modernpolitics_userfollowaction')

        # Deleting model 'EditedAction'
        db.delete_table('modernpolitics_editedaction')
