...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.upvotes'
        db.add_column('modernpolitics_userprofile', 'upvotes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.downvotes'
        db.add_column('modernpolitics_userprofile', 'downvotes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.upvotes'
        db.delete_column('modernpolitics_userprofile', 'upvotes')

        # Deleting field 'UserProfile.downvotes'
        db.delete_column('modernpolitics_userprofile', 'downvotes')
