...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientAnalytics'
        db.create_table('modernpolitics_clientanalytics', (
        ...
        db.send_create_signal('modernpolitics', ['ClientAnalytics'])


    def backwards(self, orm):
        # Deleting model 'ClientAnalytics'
        db.delete_table('modernpolitics_clientanalytics')
