...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatePoliticianGroup'
        db.create_table('modernpolitics_statepoliticiangroup', (
            ('politiciangroup_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.PoliticianGroup'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['StatePoliticianGroup'])

        # Adding model 'DistrictPoliticianGroup'
        db.create_table('modernpolitics_districtpoliticiangroup', (
            ('politiciangroup_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.PoliticianGroup'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['DistrictPoliticianGroup'])

        # Adding M2M table for field representatives on 'DistrictPoliticianGroup'
        db.create_table('modernpolitics_districtpoliticiangroup_representatives', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('districtpoliticiangroup', models.ForeignKey(orm['modernpolitics.districtpoliticiangroup'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_districtpoliticiangroup_representatives', ['districtpoliticiangroup_id', 'userprofile_id'])

        # Adding M2M table for field senators on 'DistrictPoliticianGroup'
        db.create_table('modernpolitics_districtpoliticiangroup_senators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('districtpoliticiangroup', models.ForeignKey(orm['modernpolitics.districtpoliticiangroup'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_districtpoliticiangroup_senators', ['districtpoliticiangroup_id', 'userprofile_id'])

        # Adding field 'UserProfile.primary_role'
        db.add_column('modernpolitics_userprofile', 'primary_role',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.OfficeHeld'], null=True),
                      keep_default=False)

        # Adding field 'Office.representative'
        db.add_column('modernpolitics_office', 'representative',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Office.senator'
        db.add_column('modernpolitics_office', 'senator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StatePoliticianGroup'
        db.delete_table('modernpolitics_statepoliticiangroup')

        # Deleting model 'DistrictPoliticianGroup'
        db.delete_table('modernpolitics_districtpoliticiangroup')

        # Removing M2M table for field representatives on 'DistrictPoliticianGroup'
        db.delete_table('modernpolitics_districtpoliticiangroup_representatives')

        # Removing M2M table for field senators on 'DistrictPoliticianGroup'
        db.delete_table('modernpolitics_districtpoliticiangroup_senators')

        # Deleting field 'UserProfile.primary_role'
        db.delete_column('modernpolitics_userprofile', 'primary_role_id')

        # Deleting field 'Office.representative'
        db.delete_column('modernpolitics_office', 'representative')

        # Deleting field 'Office.senator'
        db.delete_column('modernpolitics_office', 'senator')
