...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResetPassword.created_when'
        db.add_column('modernpolitics_resetpassword', 'created_when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ViewComparison.optimized'
        db.add_column('modernpolitics_viewcomparison', 'optimized',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResetPassword.created_when'
        db.delete_column('modernpolitics_resetpassword', 'created_when')

        # Deleting field 'ViewComparison.optimized'
        db.delete_column('modernpolitics_viewcomparison', 'optimized')
