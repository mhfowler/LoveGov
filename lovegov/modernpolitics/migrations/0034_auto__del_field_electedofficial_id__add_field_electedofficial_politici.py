...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ElectedOfficial.id'
        db.delete_column('modernpolitics_electedofficial', 'id')

        # Adding field 'ElectedOfficial.politician_ptr'
        db.add_column('modernpolitics_electedofficial', 'politician_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=-1, to=orm['modernpolitics.Politician'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ElectedOfficial.id'
        raise RuntimeError("Cannot reverse this migration. 'ElectedOfficial.id' and its values cannot be restored.")
        # Deleting field 'ElectedOfficial.politician_ptr'
        db.delete_column('modernpolitics_electedofficial', 'politician_ptr_id')
