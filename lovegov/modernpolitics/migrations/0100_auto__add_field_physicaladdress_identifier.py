...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhysicalAddress.identifier'
        db.add_column('modernpolitics_physicaladdress', 'identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhysicalAddress.identifier'
        db.delete_column('modernpolitics_physicaladdress', 'identifier')
