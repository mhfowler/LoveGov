...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.top_poll'
        db.add_column('modernpolitics_question', 'top_poll',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Poll'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.top_poll'
        db.delete_column('modernpolitics_question', 'top_poll_id')
