...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhysicalAddress.longitude'
        db.alter_column('modernpolitics_physicaladdress', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=30, decimal_places=15))

        # Changing field 'PhysicalAddress.latitude'
        db.alter_column('modernpolitics_physicaladdress', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=30, decimal_places=15))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PhysicalAddress.state'
        raise RuntimeError("Cannot reverse this migration. 'PhysicalAddress.state' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PhysicalAddress.longitude'
        raise RuntimeError("Cannot reverse this migration. 'PhysicalAddress.longitude' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PhysicalAddress.latitude'
        raise RuntimeError("Cannot reverse this migration. 'PhysicalAddress.latitude' and its values cannot be restored.")
