...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modernpolitics_discussion', (
        ...
        db.send_create_signal('modernpolitics', ['Discussion'])

        # Adding field 'Motion.expiration_date'
        db.add_column('modernpolitics_motion', 'expiration_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Motion.passed'
        db.add_column('modernpolitics_motion', 'passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Motion.expired'
        db.add_column('modernpolitics_motion', 'expired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Motion.above_threshold'
        db.add_column('modernpolitics_motion', 'above_threshold',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Motion.moderator'
        db.add_column('modernpolitics_motion', 'moderator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True),
                      keep_default=False)

        # Adding field 'Motion.government_type'
        db.add_column('modernpolitics_motion', 'government_type',
                      self.gf('django.db.models.fields.CharField')(default='traditional', max_length=30),
                      keep_default=False)


        # Changing field 'Motion.motion_type'
        db.alter_column('modernpolitics_motion', 'motion_type', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Deleting field 'Topic.forum'
        db.delete_column('modernpolitics_topic', 'forum_id')

        # Adding field 'Group.government_type'
        db.add_column('modernpolitics_group', 'government_type',
                      self.gf('django.db.models.fields.CharField')(default='traditional', max_length=30),
                      keep_default=False)

        # Adding field 'Group.participation_threshold'
        db.add_column('modernpolitics_group', 'participation_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=30),
                      keep_default=False)

        # Adding field 'Group.agreement_threshold'
        db.add_column('modernpolitics_group', 'agreement_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=50),
                      keep_default=False)

        # Adding field 'Group.motion_expiration'
        db.add_column('modernpolitics_group', 'motion_expiration',
        ...
        # Adding field 'Content.posted_to'
        db.add_column('modernpolitics_content', 'posted_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='posted_content', null=True, to=orm['modernpolitics.Group']),
                      keep_default=False)

        # Adding field 'Content.content_privacy'
        db.add_column('modernpolitics_content', 'content_privacy',
                      self.gf('django.db.models.fields.CharField')(default='O', max_length=1),
                      keep_default=False)

        # Adding M2M table for field shared_to on 'Content'
        db.create_table('modernpolitics_content_shared_to', (
        ...
        db.create_unique('modernpolitics_content_shared_to', ['content_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('modernpolitics_discussion')

        # Deleting field 'Motion.expiration_date'
        db.delete_column('modernpolitics_motion', 'expiration_date')

        # Deleting field 'Motion.passed'
        db.delete_column('modernpolitics_motion', 'passed')

        # Deleting field 'Motion.expired'
        db.delete_column('modernpolitics_motion', 'expired')

        # Deleting field 'Motion.above_threshold'
        db.delete_column('modernpolitics_motion', 'above_threshold')

        # Deleting field 'Motion.moderator'
        db.delete_column('modernpolitics_motion', 'moderator_id')

        # Deleting field 'Motion.government_type'
        db.delete_column('modernpolitics_motion', 'government_type')


        # Changing field 'Motion.motion_type'
        db.alter_column('modernpolitics_motion', 'motion_type', self.gf('django.db.models.fields.CharField')(max_length=1))
        # Adding field 'Topic.forum'
        db.add_column('modernpolitics_topic', 'forum',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Forum'], null=True),
                      keep_default=False)

        # Deleting field 'Group.government_type'
        db.delete_column('modernpolitics_group', 'government_type')

        # Deleting field 'Group.participation_threshold'
        db.delete_column('modernpolitics_group', 'participation_threshold')

        # Deleting field 'Group.agreement_threshold'
        db.delete_column('modernpolitics_group', 'agreement_threshold')

        # Deleting field 'Group.motion_expiration'
        db.delete_column('modernpolitics_group', 'motion_expiration')
        ...
        # Deleting field 'Content.posted_to'
        db.delete_column('modernpolitics_content', 'posted_to_id')

        # Deleting field 'Content.content_privacy'
        db.delete_column('modernpolitics_content', 'content_privacy')

        # Removing M2M table for field shared_to on 'Content'
        db.delete_table('modernpolitics_content_shared_to')
    ...
    models = {
        ...
        'modernpolitics.electedofficial': {
            'Meta': {'object_name': 'ElectedOfficial', '_ormbases': ['modernpolitics.Politician']},
            ...
            'politician_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['modernpolitics.Politician']", 'unique': 'True', 'primary_key': 'True'}),
