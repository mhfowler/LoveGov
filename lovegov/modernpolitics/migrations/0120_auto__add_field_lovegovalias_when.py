...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LoveGovAlias.when'
        db.add_column('modernpolitics_lovegovalias', 'when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LoveGovAlias.when'
        db.delete_column('modernpolitics_lovegovalias', 'when')
    ...
    models = {
        ...
        'modernpolitics.lovegovalias': {
            'Meta': {'object_name': 'LoveGovAlias'},
        ...
        'modernpolitics.userprofile': {
            ...
            'show_share_matches': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
