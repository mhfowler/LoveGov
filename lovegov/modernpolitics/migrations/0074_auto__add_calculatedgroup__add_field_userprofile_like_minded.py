...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalculatedGroup'
        db.create_table('modernpolitics_calculatedgroup', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Group'], unique=True, primary_key=True)),
            ('calculation_type', self.gf('django.db.models.fields.CharField')(default='LM', max_length=2)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'])),
        ))
        db.send_create_signal('modernpolitics', ['CalculatedGroup'])

        # Adding M2M table for field processed on 'CalculatedGroup'
        db.create_table('modernpolitics_calculatedgroup_processed', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calculatedgroup', models.ForeignKey(orm['modernpolitics.calculatedgroup'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_calculatedgroup_processed', ['calculatedgroup_id', 'userprofile_id'])

        # Adding field 'UserProfile.like_minded'
        db.add_column('modernpolitics_userprofile', 'like_minded',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_origin', null=True, to=orm['modernpolitics.CalculatedGroup']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'CalculatedGroup'
        db.delete_table('modernpolitics_calculatedgroup')

        # Removing M2M table for field processed on 'CalculatedGroup'
        db.delete_table('modernpolitics_calculatedgroup_processed')

        # Deleting field 'UserProfile.like_minded'
        db.delete_column('modernpolitics_userprofile', 'like_minded_id')
