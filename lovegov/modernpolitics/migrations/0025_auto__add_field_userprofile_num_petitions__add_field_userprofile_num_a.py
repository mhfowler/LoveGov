...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.num_petitions'
        db.add_column('modernpolitics_userprofile', 'num_petitions',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.num_articles'
        db.add_column('modernpolitics_userprofile', 'num_articles',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.num_petitions'
        db.delete_column('modernpolitics_userprofile', 'num_petitions')

        # Deleting field 'UserProfile.num_articles'
        db.delete_column('modernpolitics_userprofile', 'num_articles')
