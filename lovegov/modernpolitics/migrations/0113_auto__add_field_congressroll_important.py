...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CongressRoll.important'
        db.add_column('modernpolitics_congressroll', 'important',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CongressRoll.important'
        db.delete_column('modernpolitics_congressroll', 'important')
