...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnonID'
        db.create_table('modernpolitics_anonid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('modernpolitics', ['AnonID'])

        # Adding model 'LGNumber'
        db.create_table('modernpolitics_lgnumber', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alias', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('modernpolitics', ['LGNumber'])

        # Adding M2M table for field anonymous on 'UserProfile'
        db.create_table('modernpolitics_userprofile_anonymous', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('anonid', models.ForeignKey(orm['modernpolitics.anonid'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_anonymous', ['userprofile_id', 'anonid_id'])


    def backwards(self, orm):
        # Deleting model 'AnonID'
        db.delete_table('modernpolitics_anonid')

        # Deleting model 'LGNumber'
        db.delete_table('modernpolitics_lgnumber')

        # Removing M2M table for field anonymous on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_anonymous')
