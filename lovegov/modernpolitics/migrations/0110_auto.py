...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field supports on 'CookieData'
        db.create_table('modernpolitics_cookiedata_supports', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cookiedata', models.ForeignKey(orm['modernpolitics.cookiedata'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_cookiedata_supports', ['cookiedata_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field supports on 'CookieData'
        db.delete_table('modernpolitics_cookiedata_supports')
