...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_share_matches'
        db.add_column('modernpolitics_userprofile', 'show_share_matches',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_share_matches'
        db.delete_column('modernpolitics_userprofile', 'show_share_matches')
