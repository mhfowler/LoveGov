...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupFollowAction'
        db.create_table('modernpolitics_groupfollowaction', (
        ...
        db.send_create_signal('modernpolitics', ['GroupFollowAction'])

        # Adding field 'UserProfile.currently_in_office'
        db.add_column('modernpolitics_userprofile', 'currently_in_office',
        ...
        # Adding M2M table for field group_subscriptions on 'UserProfile'
        db.create_table('modernpolitics_userprofile_group_subscriptions', (
        ...
        db.create_unique('modernpolitics_userprofile_group_subscriptions', ['userprofile_id', 'group_id'])

        # Adding field 'Group.subscribable'
        db.add_column('modernpolitics_group', 'subscribable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Group.content_by_posting'
        db.add_column('modernpolitics_group', 'content_by_posting',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GroupFollowAction'
        db.delete_table('modernpolitics_groupfollowaction')

        # Deleting field 'UserProfile.currently_in_office'
        db.delete_column('modernpolitics_userprofile', 'currently_in_office')
        ...
        # Removing M2M table for field group_subscriptions on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_group_subscriptions')

        # Deleting field 'Group.subscribable'
        db.delete_column('modernpolitics_group', 'subscribable')

        # Deleting field 'Group.content_by_posting'
        db.delete_column('modernpolitics_group', 'content_by_posting')
