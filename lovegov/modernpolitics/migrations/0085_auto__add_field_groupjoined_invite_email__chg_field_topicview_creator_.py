...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupJoined.invite_email'
        db.add_column('modernpolitics_groupjoined', 'invite_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


        # Changing field 'TopicView.creator'
        db.alter_column('modernpolitics_topicview', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True))
        # Adding field 'Relationship.invite_email'
        db.add_column('modernpolitics_relationship', 'invite_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


        # Changing field 'Relationship.creator'
        db.alter_column('modernpolitics_relationship', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True))

        # Changing field 'Relationship.user'
        db.alter_column('modernpolitics_relationship', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['modernpolitics.UserProfile']))

        # Changing field 'Action.creator'
        db.alter_column('modernpolitics_action', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True))

        # Changing field 'Notification.creator'
        db.alter_column('modernpolitics_notification', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True))

        # Changing field 'Content.creator'
        db.alter_column('modernpolitics_content', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True))
        # Adding field 'UserFollow.invite_email'
        db.add_column('modernpolitics_userfollow', 'invite_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupJoined.invite_email'
        db.delete_column('modernpolitics_groupjoined', 'invite_email')


        # Changing field 'TopicView.creator'
        db.alter_column('modernpolitics_topicview', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile']))
        # Deleting field 'Relationship.invite_email'
        db.delete_column('modernpolitics_relationship', 'invite_email')


        # Changing field 'Relationship.creator'
        db.alter_column('modernpolitics_relationship', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile']))

        # User chose to not deal with backwards NULL issues for 'Relationship.user'
        raise RuntimeError("Cannot reverse this migration. 'Relationship.user' and its values cannot be restored.")

        # Changing field 'Action.creator'
        db.alter_column('modernpolitics_action', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile']))

        # Changing field 'Notification.creator'
        db.alter_column('modernpolitics_notification', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile']))

        # Changing field 'Content.creator'
        db.alter_column('modernpolitics_content', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile']))
        # Deleting field 'UserFollow.invite_email'
        db.delete_column('modernpolitics_userfollow', 'invite_email')
