...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CongressVote.votevalue'
        db.alter_column('modernpolitics_congressvote', 'votevalue', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'LegislationAction.text'
        db.alter_column('modernpolitics_legislationaction', 'text', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CongressVote.votevalue'
        db.alter_column('modernpolitics_congressvote', 'votevalue', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'LegislationAction.text'
        db.alter_column('modernpolitics_legislationaction', 'text', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))
