...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.explanation_comment'
        db.add_column('modernpolitics_response', 'explanation_comment',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Comment'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.explanation_comment'
        db.delete_column('modernpolitics_response', 'explanation_comment_id')
