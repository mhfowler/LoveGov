...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.official_order'
        db.add_column('modernpolitics_question', 'official_order',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.official_order'
        db.delete_column('modernpolitics_question', 'official_order')
