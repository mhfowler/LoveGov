...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Content.alias'
        db.alter_column('modernpolitics_content', 'alias', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Content.alias'
        db.alter_column('modernpolitics_content', 'alias', self.gf('django.db.models.fields.CharField')(max_length=30))
