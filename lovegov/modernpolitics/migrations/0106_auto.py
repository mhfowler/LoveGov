...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field digested_content on 'UserProfile'
        db.create_table('modernpolitics_userprofile_digested_content', (
        ...
        db.create_unique('modernpolitics_userprofile_digested_content', ['userprofile_id', 'content_id'])


    def backwards(self, orm):
        # Removing M2M table for field digested_content on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_digested_content')
