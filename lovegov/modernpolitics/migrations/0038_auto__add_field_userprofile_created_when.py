...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.created_when'
        db.add_column('modernpolitics_userprofile', 'created_when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.created_when'
        db.delete_column('modernpolitics_userprofile', 'created_when')
