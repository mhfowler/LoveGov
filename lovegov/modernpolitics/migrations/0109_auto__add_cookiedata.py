...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modernpolitics_cookiedata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('view', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.WorldView'], null=True)),
        ...
        db.send_create_signal('modernpolitics', ['CookieData'])


    def backwards(self, orm):
        # Deleting model 'CookieData'
        db.delete_table('modernpolitics_cookiedata')
