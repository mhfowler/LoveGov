...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Legislation.full_title'
        db.alter_column('modernpolitics_legislation', 'full_title', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

    def backwards(self, orm):

        # Changing field 'Legislation.full_title'
        db.alter_column('modernpolitics_legislation', 'full_title', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
