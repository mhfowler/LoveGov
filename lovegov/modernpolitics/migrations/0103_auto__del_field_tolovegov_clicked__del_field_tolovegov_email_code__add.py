...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'toLoveGov.clicked'
        db.delete_column('modernpolitics_tolovegov', 'clicked')

        # Deleting field 'toLoveGov.email_code'
        db.delete_column('modernpolitics_tolovegov', 'email_code')

        # Adding field 'toLoveGov.clicks'
        db.add_column('modernpolitics_tolovegov', 'clicks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'toLoveGov.clicked'
        db.add_column('modernpolitics_tolovegov', 'clicked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'toLoveGov.email_code'
        db.add_column('modernpolitics_tolovegov', 'email_code',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'toLoveGov.clicks'
        db.delete_column('modernpolitics_tolovegov', 'clicks')
