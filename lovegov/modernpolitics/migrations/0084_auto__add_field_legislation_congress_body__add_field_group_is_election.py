...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Legislation.congress_body'
        db.add_column('modernpolitics_legislation', 'congress_body',
                      self.gf('django.db.models.fields.CharField')(default='H', max_length=1),
                      keep_default=False)

        # Removing M2M table for field election_subscriptions on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_election_subscriptions')

        # Adding field 'Group.is_election'
        db.add_column('modernpolitics_group', 'is_election',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Election.invite_only'
        db.delete_column('modernpolitics_election', 'invite_only')

        # Removing M2M table for field running on 'Election'
        db.delete_table('modernpolitics_election_running')


        # Changing field 'Election.election_date'
        db.alter_column('modernpolitics_election', 'election_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Legislation.congress_body'
        db.delete_column('modernpolitics_legislation', 'congress_body')

        # Adding M2M table for field election_subscriptions on 'UserProfile'
        db.create_table('modernpolitics_userprofile_election_subscriptions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('election', models.ForeignKey(orm['modernpolitics.election'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_election_subscriptions', ['userprofile_id', 'election_id'])

        # Deleting field 'Group.is_election'
        db.delete_column('modernpolitics_group', 'is_election')

        # Adding field 'Election.invite_only'
        db.add_column('modernpolitics_election', 'invite_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field running on 'Election'
        db.create_table('modernpolitics_election_running', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('election', models.ForeignKey(orm['modernpolitics.election'], null=False)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False))
        ))
        db.create_unique('modernpolitics_election_running', ['election_id', 'userprofile_id'])


        # Changing field 'Election.election_date'
        db.alter_column('modernpolitics_election', 'election_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
