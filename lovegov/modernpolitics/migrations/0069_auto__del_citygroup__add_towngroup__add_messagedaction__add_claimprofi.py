...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CityGroup'
        db.delete_table('modernpolitics_citygroup')

        # Adding model 'TownGroup'
        db.create_table('modernpolitics_towngroup', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Group'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['TownGroup'])

        # Adding model 'MessagedAction'
        db.create_table('modernpolitics_messagedaction', (
            ...
            ('politician', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('modernpolitics', ['MessagedAction'])

        # Adding model 'ClaimProfile'
        db.create_table('modernpolitics_claimprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='claims', to=orm['modernpolitics.UserProfile'])),
            ('politician', self.gf('django.db.models.fields.related.ForeignKey')(related_name='claimers', to=orm['modernpolitics.UserProfile'])),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('modernpolitics', ['ClaimProfile'])

        # Adding model 'AskedAction'
        db.create_table('modernpolitics_askedaction', (
            ('action_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Action'], unique=True, primary_key=True)),
            ('politician', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'])),
        ))
        db.send_create_signal('modernpolitics', ['AskedAction'])

        # Adding model 'PoliticianGroup'
        db.create_table('modernpolitics_politiciangroup', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Group'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['PoliticianGroup'])

        # Adding field 'OfficeHeld.current'
        db.add_column('modernpolitics_officeheld', 'current',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.num_messages'
        db.add_column('modernpolitics_userprofile', 'num_messages',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'CityGroup'
        db.create_table('modernpolitics_citygroup', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['modernpolitics.Group'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('modernpolitics', ['CityGroup'])

        # Deleting model 'TownGroup'
        db.delete_table('modernpolitics_towngroup')

        # Deleting model 'MessagedAction'
        db.delete_table('modernpolitics_messagedaction')

        # Deleting model 'ClaimProfile'
        db.delete_table('modernpolitics_claimprofile')

        # Deleting model 'AskedAction'
        db.delete_table('modernpolitics_askedaction')

        # Deleting model 'PoliticianGroup'
        db.delete_table('modernpolitics_politiciangroup')

        # Deleting field 'OfficeHeld.current'
        db.delete_column('modernpolitics_officeheld', 'current')

        # Deleting field 'UserProfile.num_messages'
        db.delete_column('modernpolitics_userprofile', 'num_messages')
