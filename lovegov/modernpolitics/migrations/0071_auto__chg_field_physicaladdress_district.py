...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhysicalAddress.district'
        db.alter_column('modernpolitics_physicaladdress', 'district', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PhysicalAddress.district'
        db.alter_column('modernpolitics_physicaladdress', 'district', self.gf('django.db.models.fields.IntegerField')())
