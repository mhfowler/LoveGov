...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.share_group'
        db.add_column('modernpolitics_action', 'share_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Group'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.share_group'
        db.delete_column('modernpolitics_action', 'share_group_id')
    ...
    models = {
        ...
        'modernpolitics.action': {
            ...
            'share_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modernpolitics.Group']", 'null': 'True'}),
