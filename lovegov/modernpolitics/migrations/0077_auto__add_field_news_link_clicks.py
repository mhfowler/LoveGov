...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.link_clicks'
        db.add_column('modernpolitics_news', 'link_clicks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.link_clicks'
        db.delete_column('modernpolitics_news', 'link_clicks')
