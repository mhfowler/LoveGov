...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SimpleFilter.created_when'
        db.add_column('modernpolitics_simplefilter', 'created_when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SimpleFilter.creator'
        db.add_column('modernpolitics_simplefilter', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SimpleFilter.created_when'
        db.delete_column('modernpolitics_simplefilter', 'created_when')

        # Deleting field 'SimpleFilter.creator'
        db.delete_column('modernpolitics_simplefilter', 'creator_id')
