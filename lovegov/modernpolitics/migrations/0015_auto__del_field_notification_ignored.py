...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.ignored'
        db.delete_column('modernpolitics_notification', 'ignored')


    def backwards(self, orm):
        # Adding field 'Notification.ignored'
        db.add_column('modernpolitics_notification', 'ignored',
