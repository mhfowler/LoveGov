...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.political_title'
        db.add_column('modernpolitics_userprofile', 'political_title',
                      self.gf('django.db.models.fields.CharField')(default='Citizen', max_length=100),
                      keep_default=False)


        # Changing field 'CongressRoll.required'
        db.alter_column('modernpolitics_congressroll', 'required', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting field 'UserProfile.type'
        db.delete_column('modernpolitics_userprofile', 'type')

        # Deleting field 'UserProfile.political_title'
        db.delete_column('modernpolitics_userprofile', 'political_title')


        # Changing field 'CongressRoll.required'
        db.alter_column('modernpolitics_congressroll', 'required', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
