...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageAccess.post_parameters'
        db.add_column('modernpolitics_pageaccess', 'post_parameters',
                      self.gf('django.db.models.fields.CharField')(max_length=5000, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageAccess.post_parameters'
        db.delete_column('modernpolitics_pageaccess', 'post_parameters')
