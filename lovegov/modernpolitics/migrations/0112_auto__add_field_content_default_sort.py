...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.default_sort'
        db.add_column('modernpolitics_content', 'default_sort',
                      self.gf('django.db.models.fields.CharField')(default='h', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.default_sort'
        db.delete_column('modernpolitics_content', 'default_sort')
