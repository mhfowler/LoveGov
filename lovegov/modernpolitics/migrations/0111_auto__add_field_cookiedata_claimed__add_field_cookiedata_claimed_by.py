...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CookieData.claimed'
        db.add_column('modernpolitics_cookiedata', 'claimed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CookieData.claimed_by'
        db.add_column('modernpolitics_cookiedata', 'claimed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_cookie_datas', null=True, to=orm['modernpolitics.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CookieData.claimed'
        db.delete_column('modernpolitics_cookiedata', 'claimed')

        # Deleting field 'CookieData.claimed_by'
        db.delete_column('modernpolitics_cookiedata', 'claimed_by_id')
