...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SupportedAction'
        db.create_table('modernpolitics_supportedaction', (
            ...
            ('support', self.gf('django.db.models.fields.related.ForeignKey')(related_name='support_actions', to=orm['modernpolitics.Supported'])),
            ('modifier', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('modernpolitics', ['SupportedAction'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SupportedAction'
        db.delete_table('modernpolitics_supportedaction')
    ...
    models = {
        ...
        'modernpolitics.citygroup': {
            'Meta': {'object_name': 'CityGroup', '_ormbases': ['modernpolitics.Group']},
