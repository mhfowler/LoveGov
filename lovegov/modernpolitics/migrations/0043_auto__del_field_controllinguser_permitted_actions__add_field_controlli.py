...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ControllingUser.permitted_actions'
        db.delete_column('modernpolitics_controllinguser', 'permitted_actions')

        # Adding field 'ControllingUser.prohibited_actions'
        db.add_column('modernpolitics_controllinguser', 'prohibited_actions',
                      self.gf('lovegov.modernpolitics.custom_fields.ListField')(default=[]),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ControllingUser.permitted_actions'
        db.add_column('modernpolitics_controllinguser', 'permitted_actions',
                      self.gf('lovegov.modernpolitics.custom_fields.ListField')(default=['loadGroupUsers', 'loadHistogram', 'searchAutoComplete', 'comment', 'create', 'invite', 'editAccount', 'editProfile', 'editContent', 'delete', 'setPrivacy', 'setFollowPrivacy', 'vote', 'hoverComparison', 'sign', 'finalize', 'userFollowRequest', 'userFollowResponse', 'userFollowStop', 'answer', 'joinGroupRequest', 'joinGroupResponse', 'groupInviteResponse', 'leaveGroup', 'matchComparison', 'posttogroup', 'updateCompare', 'viewCompare', 'answerWeb', 'feedback', 'updateGroupView', 'ajaxThread', 'getNotifications', 'getUserActions', 'getUserGroups', 'getGroupActions', 'getGroupMembers', 'ajaxGetFeed', 'matchSection', 'saveFilter', 'deleteFilter', 'getFilter', 'shareContent', 'blogAction', 'flag', 'updateHistogram', 'getHistogramMembers', 'getAllGroupMembers', 'support', 'messageRep', 'submitAddress', 'likeThis', 'changeContentPrivacy', 'updatePage', 'getAggregateNotificationUsers', 'getSigners', 'setFirstLoginStage']),
                      keep_default=False)

        # Deleting field 'ControllingUser.prohibited_actions'
        db.delete_column('modernpolitics_controllinguser', 'prohibited_actions')
