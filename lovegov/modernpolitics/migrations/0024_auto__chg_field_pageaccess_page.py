...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageAccess.page'
        db.alter_column('modernpolitics_pageaccess', 'page', self.gf('django.db.models.fields.CharField')(max_length=5000))

    def backwards(self, orm):

        # Changing field 'PageAccess.page'
        db.alter_column('modernpolitics_pageaccess', 'page', self.gf('django.db.models.fields.CharField')(max_length=50))
