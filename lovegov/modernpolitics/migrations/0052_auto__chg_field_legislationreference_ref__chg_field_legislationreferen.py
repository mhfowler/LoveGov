...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LegislationReference.ref'
        db.alter_column('modernpolitics_legislationreference', 'ref', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'LegislationReference.label'
        db.alter_column('modernpolitics_legislationreference', 'label', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'LegislationReference.ref'
        db.alter_column('modernpolitics_legislationreference', 'ref', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'LegislationReference.label'
        db.alter_column('modernpolitics_legislationreference', 'label', self.gf('django.db.models.fields.CharField')(max_length=200))
