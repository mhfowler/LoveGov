...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InvitedToRegister'
        db.create_table('modernpolitics_invitedtoregister', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invite_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('inviter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'])),
            ('notification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Notification'])),
        ))
        db.send_create_signal('modernpolitics', ['InvitedToRegister'])

        # Adding model 'AddToScorecardAction'
        db.create_table('modernpolitics_addtoscorecardaction', (
            ...
            ('politician', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.UserProfile'], null=True)),
            ('invite_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True)),
            ('scorecard', self.gf('django.db.models.fields.related.ForeignKey')(related_name='added_actions', to=orm['modernpolitics.Scorecard'])),
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('modernpolitics', ['AddToScorecardAction'])

        # Adding field 'Notification.notify_email'
        db.add_column('modernpolitics_notification', 'notify_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


        # Changing field 'Notification.notify_user'
        db.alter_column('modernpolitics_notification', 'notify_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['modernpolitics.UserProfile']))

    def backwards(self, orm):
        # Deleting model 'InvitedToRegister'
        db.delete_table('modernpolitics_invitedtoregister')

        # Deleting model 'AddToScorecardAction'
        db.delete_table('modernpolitics_addtoscorecardaction')

        # Deleting field 'Notification.notify_email'
        db.delete_column('modernpolitics_notification', 'notify_email')


        # Changing field 'Notification.notify_user'
        db.alter_column('modernpolitics_notification', 'notify_user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['modernpolitics.UserProfile']))
    ...
    models = {
        ...
        'modernpolitics.userprofile': {
            ...
            'election_subscriptions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'users_tracking'", 'symmetrical': 'False', 'to': "orm['modernpolitics.Election']"}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
