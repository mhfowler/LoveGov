...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.network'
        db.delete_column('modernpolitics_userprofile', 'network_id')

        # Adding field 'UserProfile.user_title'
        db.add_column('modernpolitics_userprofile', 'user_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding M2M table for field networks on 'UserProfile'
        db.create_table('modernpolitics_userprofile_networks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['modernpolitics.userprofile'], null=False)),
            ('network', models.ForeignKey(orm['modernpolitics.network'], null=False))
        ))
        db.create_unique('modernpolitics_userprofile_networks', ['userprofile_id', 'network_id'])

        # Adding field 'Network.network_type'
        db.add_column('modernpolitics_network', 'network_type',
                      self.gf('django.db.models.fields.CharField')(default='D', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.network'
        db.add_column('modernpolitics_userprofile', 'network',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modernpolitics.Network'], null=True),
                      keep_default=False)

        # Deleting field 'UserProfile.user_title'
        db.delete_column('modernpolitics_userprofile', 'user_title')

        # Removing M2M table for field networks on 'UserProfile'
        db.delete_table('modernpolitics_userprofile_networks')

        # Deleting field 'Network.network_type'
        db.delete_column('modernpolitics_network', 'network_type')
