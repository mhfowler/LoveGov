...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnsubscribedToEmail'
        db.create_table('modernpolitics_unsubscribedtoemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('modernpolitics', ['UnsubscribedToEmail'])


    def backwards(self, orm):
        # Deleting model 'UnsubscribedToEmail'
        db.delete_table('modernpolitics_unsubscribedtoemail')
