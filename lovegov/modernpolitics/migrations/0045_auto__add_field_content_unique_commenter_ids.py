...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.unique_commenter_ids'
        db.add_column('modernpolitics_content', 'unique_commenter_ids',
    ...
    def backwards(self, orm):
        # Deleting field 'Content.unique_commenter_ids'
        db.delete_column('modernpolitics_content', 'unique_commenter_ids')
