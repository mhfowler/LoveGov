...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.follow_me'
        db.add_column('modernpolitics_userprofile', 'follow_me',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='follow_me', null=True, to=orm['modernpolitics.Group']),
                      keep_default=False)

        # Adding field 'UserProfile.private_follow'
        db.add_column('modernpolitics_userprofile', 'private_follow',
    ...
    def backwards(self, orm):
        # Deleting field 'UserProfile.follow_me'
        db.delete_column('modernpolitics_userprofile', 'follow_me_id')

        # Deleting field 'UserProfile.private_follow'
        db.delete_column('modernpolitics_userprofile', 'private_follow')
