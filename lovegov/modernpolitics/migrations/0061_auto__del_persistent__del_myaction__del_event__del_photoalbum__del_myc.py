...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Poll'
        db.create_table('modernpolitics_poll', (
            ...
            ('num_questions', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('modernpolitics', ['Poll'])

        # Adding M2M table for field questions on 'Poll'
        db.create_table('modernpolitics_poll_questions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('poll', models.ForeignKey(orm['modernpolitics.poll'], null=False)),
            ('question', models.ForeignKey(orm['modernpolitics.question'], null=False))
        ))
        db.create_unique('modernpolitics_poll_questions', ['poll_id', 'question_id'])

        # Adding field 'UserProfile.political_statement'
        db.add_column('modernpolitics_userprofile', 'political_statement',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Poll'
        db.delete_table('modernpolitics_poll')

        # Removing M2M table for field questions on 'Poll'
        db.delete_table('modernpolitics_poll_questions')

        # Deleting field 'UserProfile.political_statement'
        db.delete_column('modernpolitics_userprofile', 'political_statement')
