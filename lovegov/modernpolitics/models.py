...
class BasicInfo(models.Model):
    ...
    # FIELDS
    middle_name = models.CharField(max_length=100, blank=True, default="unspecified")
    nick_name = models.CharField(max_length=100, blank=True, default="unspecified")
    gender = models.CharField(max_length=1, choices=GENDER_CHOICES, blank=True, default="unspecified")
    dob = models.DateField(null=True)
    address = custom_fields.ListField(default=[])
    state = models.CharField(max_length=2, blank=True, default="unspecified")
    zipcode = models.CharField(max_length=15, blank=True, default="unspecified")
    url = custom_fields.ListField(default=[])
    religion = models.CharField(max_length=200, blank=True, default="unspecified")
    ethnicity = models.CharField(max_length=30, blank=True, default="unspecified")
    party = models.CharField(max_length=100, blank=True, default="unspecified")
    political_role = models.CharField(max_length=1, choices=ROLE_CHOICES, blank=True, default="unspecified")
    ...
    bio = models.CharField(max_length=150, blank=True, default="unspecified")
