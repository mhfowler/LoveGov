...
({
    init: function(domEle, comparisonJSON)
    {
        ...
        this.skew = 100;
        if (this.dataObj['user_url'] != '') { this.domEle.append('<a style="position:absolute;top:15px;right:15px;z-index:100" class="do-ajax-link" href="' + this.dataObj['user_url'] + '"><img src="/static/images/fullscreen_alt.png" style="width:25px"/></a>')}
        loadAjaxifyAnchors();
    },
