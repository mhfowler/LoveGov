...
({
    init: function(divID, comparisonJSON)
    {
        ...
        this.skew = 100;
        if (this.dataObj['user_url'] != '') { $('#' + divID).append('<a style="position:absolute;top:10px;right:10px;z-index:5000" class="do-ajax-link" href="' + this.dataObj['user_url'] + '"><img src="/static/images/fullscreen_alt.png" style="width:25px"/></a>')}
        loadAjaxifyAnchors();
    },
