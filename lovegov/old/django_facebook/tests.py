...
from lovegov.old.django_facebook.auth_backends import FacebookBackend
from lovegov.old.django_facebook.connect import (_register_user, connect_user,
                                     CONNECT_ACTIONS)
from lovegov.old.django_facebook.tests_utils.base import FacebookTest
...
from lovegov.old.django_facebook.utils import cleanup_oauth_url
from lovegov.old.django_facebook import signals

logger = logging.getLogger(__name__)


__doctests__ = ['lovegov.beta.django_facebook.api']
...
class UserConnectTest(FacebookTest):
    ...
    def test_registration_form(self):
        ...
        '''
        facebook_settings.FACEBOOK_REGISTRATION_FORM = 'lovegov.beta.django_facebook.tests_utils.forms.SignupForm'
        facebook = get_facebook_graph(access_token='short_username')
        action, user = connect_user(self.request, facebook_graph=facebook)
