...
from lovegov.old.django_facebook import settings as facebook_settings, settings
...
def test_permissions(request, scope_list, redirect_uri=None):
    ...
    '''
    from lovegov.old.django_facebook.api import get_persistent_graph
...
def next_redirect(request, default='/home/', additional_params=None,
...
def get_form_class(backend, request):
    ...
    '''
    from lovegov.old.django_facebook import settings as facebook_settings
    form_class = None
