...
from lovegov.old.django_facebook.utils import get_oauth_url, parse_scope, response_redirect
...
def facebook_required(view_func=None, scope=fb_settings.FACEBOOK_DEFAULT_SCOPE,
    ...
    """
    from lovegov.old.django_facebook.utils import test_permissions
