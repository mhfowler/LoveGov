...
from lovegov.old.django_facebook.utils import mass_get_or_create, cleanup_oauth_url,\
    get_profile_class
...
class FacebookUserConverter(object):
    ...
    def get_and_store_likes(self, user):
        ...
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from lovegov.old.django_facebook.tasks import get_and_store_likes
    ...
    def store_likes(self, user, likes):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from lovegov.old.django_facebook.tasks import store_likes
    ...
    def _store_likes(self, user, likes):
        ...
        if likes:
            from lovegov.old.django_facebook.models import FacebookLike
    ...
    def get_and_store_friends(self, user):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from lovegov.old.django_facebook.tasks import get_and_store_friends
    ...
    def store_friends(self, user, friends):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from lovegov.old.django_facebook.tasks import store_friends
    ...
    def _store_friends(self, user, friends):
        from lovegov.old.django_facebook.models import FacebookUser
        ...
        if friends:
            ...
            for f in friends:
                # for testing
                for k, v in f:
                    print "friend[" + str(k) +"]: " + str(f.get(k))
                # end
                name = f.get('name')
